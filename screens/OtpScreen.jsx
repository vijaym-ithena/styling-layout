            ...
            <View style={{ width: '100%', flex: 1, justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                ...
                <View>
                    ...
                    <View style={{ display: 'flex', flexDirection: 'row', gap: 5 }}>
                        <Text style={{ marginVertical: 25, fontSize: 14, color: '#808080', width: 'auto', textAlign: 'left' }}>Enter OTP received on ** number **</Text>
                        <TouchableRipple
                            rippleColor={'#FFEAE0'}
                            style={{ marginVertical: 25, padding: 5, display: 'flex', alignSelf: 'flex-end' }}
                            onPress={() => navigation.navigate('phonelogin')}
                        >
                            <Text style={{ color: '#ff6a28', fontWeight: '600', fontSize: 12 }}>Change phone</Text>
                        </TouchableRipple>
                    </View>
                </View>
                <TextInput
