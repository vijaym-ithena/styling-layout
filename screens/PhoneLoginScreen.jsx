  ...
  return (
    <View style={styles.container}>
      <View>
        ...
        />
        <Text style={styles.heading}>Quick Sign-up / Sign-in with your phone</Text>
      ...
      <View>
        <TouchableRipple
          rippleColor={'#FFEAE0'}
          style={{ marginVertical: 20, padding: 5, display: 'flex', alignSelf: 'flex-end' }}
          onPress={() => navigation.navigate('login')}
        >
          <Text style={{ color: '#ff6a28', fontWeight: '600', fontSize: 12 }}>Try with Email address</Text>
        </TouchableRipple>
        <Button
          mode="contained"
        ...
        <View style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', alignSelf: 'flex-start' }}>
          <Text style={{ fontSize: 10 }}>By continuing, you agree to ITHENA's </Text>
          <TouchableRipple
            rippleColor={'#FFEAE0'}
            style={{ display: 'flex', alignSelf: 'flex-start' }}
            onPress={() => console.log('TnC pressed!')}
          >
            <Text style={{ color: '#ff6a28', fontWeight: '600', fontSize: 10 }}>Terms & Conditions</Text>
          </TouchableRipple>
          ...
          >
            <Text style={{ color: '#ff6a28', fontWeight: '600', fontSize: 10 }}>Privacy Policy</Text>
          </TouchableRipple>
        </View>
      </View>
    </View>
